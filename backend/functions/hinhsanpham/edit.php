        ...
        */
        ...
        <form name="frmhinhsanpham" id="frmhinhanpham" method="post" action="" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <br />
            <img src="/cogangvicau/assets/uploads/products/<?= $hinhsanphamRow['hsp_tentaptin'] ?>" class="img-fluid" width="300px" />
          </div>
          <div class="form-group">
          ...
          <a href="index.php" class="btn btn-outline-success" name="btnBack" id="btnBack">Quay về</a>
        </form>
