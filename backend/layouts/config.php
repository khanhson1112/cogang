...
switch ($_SERVER['SCRIPT_NAME']) {
  ...
  case "/cogangvicau/backend/functions/loaisanpham/index.php":
    $CURRENT_PAGE = "backend.shop_categories.index";
    $PAGE_TITLE = "Danh sách Loại sản phẩm";
    break;
  case "/cogangvicau/backend/functions/loaisanpham/create.php":
    $CURRENT_PAGE = "backend.loaisanpham.create";
    $PAGE_TITLE = "Thêm mới Loại sản phẩm";
    break;
  case "/coganvicau/backend/functions/loaisanpham/edit.php":
